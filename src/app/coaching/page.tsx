...
import sessionsImage from "@/assets/images/coaching-1on1-tracker.webp";
...
const whatYouGet = [
  {
    ...
    glyph: "01",
    image: sessionsImage,
    imageAlt: "A laptop on a video call sharing a client plan tracker",
  },
  {
    icon: Target,
    ...
    glyph: "02",
    image: planImage,
    imageAlt: "Ryan walking a client through a plan on a whiteboard",
  },
  {
    icon: MessageSquare,
